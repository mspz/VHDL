...
HD_PWD='/nfs/home/m1info4/Documents/git/VHDL/Log/Log.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log log2_hw.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source log2_hw.tcl
