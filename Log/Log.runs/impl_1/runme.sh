...
HD_PWD='/nfs/home/m1info4/Documents/git/VHDL/Log/Log.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log log2_hw.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source log2_hw.tcl -notrace
